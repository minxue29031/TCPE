...
from tcpe.tcpe_neuron import apply_tcpe_neuron
...
def demo_model_editing(
    ...
    if alg_name == "TCPE_PRE":
        ...
        model_new, orig_weights = apply_tcpe_neuron(
