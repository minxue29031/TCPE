...
from experiments.py.demo_oneprompt import demo_model_editing
...
def parse_arguments():
    ...
    parser.add_argument('--MODEL_NAME', type=str, required=True, help='codellama/CodeLlama-7b-Instruct-hf')
    ...
    # Arguments for KE
    parser.add_argument('--mlp_or_tc', type=str, required=False, help='Load covariance matrix: MLP, TC_ef4, TC_ef8')
    ...
    parser.add_argument('--edit_sequence_path', type=str, required=False, default="data/request/requests_last_subject.csv", help='KE requests & target cluster')
...
def main():
    ...
    request, target_KE_group, error_num, error_descp = get_tcpe_request_cluster(args)
    print("[INFO] Request:", request)
    print("[INFO] Target KE Group:", target_KE_group)
